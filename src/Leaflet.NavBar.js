	...
	L.Control.NavBar = L.Control.extend({
		...
		_goHome: function () {
			if (this.options.bbox) {
				try {
					...
					this._map.flyTo(this.options.center, this.options.zoom); //Use default if invalid bbox input.
				}
			}
			this._map.flyTo(this.options.center, this.options.zoom);
		},
		...
		_goBack: function () {
			if (this._curIndx !== 0) {
				...
				this._map.flyTo(view.center, view.zoom);
			}
		},
